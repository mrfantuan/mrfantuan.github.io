---
layout: post
title: Golang tutorial series - 22.信道
date:  2018-06-13 16:30:00
categories: Golang
tag: Go
---
...
我们其实可以重写上章学习 [Go 协程](../go-21-goroutine) 时写的程序，现在我们在这里用上信道。  
...
这是上一篇的代码。我们使用到了休眠，使 Go 主协程等待 hello 协程结束。如果你看不懂，建议你阅读上一教程 [Go 协程](../go-21-goroutine)。  
