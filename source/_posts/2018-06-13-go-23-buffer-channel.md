---
layout: post
title: Golang tutorial series - 23.缓冲信道和工作池
...
在[上一教程](../go-22-channel)里，我们讨论的主要是无缓冲信道。我们在[信道](../go-22-channel)的教程里详细讨论了，无缓冲信道的发送和接收过程是阻塞的。  
...
要让一个信道有缓冲，上面语法中的 `capacity` 应该大于 0。无缓冲信道的容量默认为 0，因此我们在[上一教程](../go-22-channel)创建信道时，省略了容量参数。  
