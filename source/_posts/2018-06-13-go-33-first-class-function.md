---
layout: post
title: Golang tutorial series - 33.函数是一等公民(头等函数)
date:  2018-06-13 18:20:00
categories: Golang
tag: Go
---
...
我们来编写一个简单的示例，把[函数](../go-17-function/)赋值给一个[变量](../go-03-variable)。
...
正如我们定义自己的[结构体](../go-16-struct)类型一样，我们可以定义自己的函数类型。
